...
export default function Header() {
  ...
  // Efekt pro zablokování scrollování body při otevření mobilního menu
  useEffect(() => {
    if (isMobileMenuOpen) {
  ...
  return (
    ...
    >
      ...
      {/* Mobile menu */}
      <div
        className={`fixed inset-0 bg-zinc-900/95 backdrop-blur-md z-40 will-change-transform ${
          isMobileMenuOpen
      ...
      >
        <div className="flex flex-col items-center justify-center h-full space-y-8 p-4 relative">
          {/* Dekorativní pozadí pro mobilní menu */}
